...
/***/ "./client/src/js/colorPickerField.js":
/*!*******************************************!*\
  !*** ./client/src/js/colorPickerField.js ***!
  \*******************************************/
/*! no exports provided */
...
Object(_util__WEBPACK_IMPORTED_MODULE_2__["default"])('.level51-color-picker-field', function (el) {
  setTimeout(function () {
    render(el);
  }, 1);
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    this.rgbValuesAvailable = !this.showCheckbox; // Check for an existing value.
    ...
    if (this.payload.value && this.payload.value !== 'null') {
      if (this.inRgbMode) {
        ...
        if (Object.values(values).filter(function (val) {
          ...
          this.rgb = "rgb(".concat(values.R, ", ").concat(values.G, ", ").concat(values.B, ")");
  ...
  computed: {
    inRgbMode: function inRgbMode() {
      return this.payload.mode === 'rgb';
    },
    inHexMode: function inHexMode() {
    ...
    colorObject: function colorObject() {
      ...
      var color = this.rgb.replace('rgb(', '').replace(')', '').split(',');
      return {
        r: color[0],
        g: color[1],
        b: color[2]
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.rgbValuesAvailable,
                  expression: "rgbValuesAvailable"
                }
              ],
              attrs: { type: "checkbox" },
              domProps: {
                checked: Array.isArray(_vm.rgbValuesAvailable)
                  ? _vm._i(_vm.rgbValuesAvailable, null) > -1
                  : _vm.rgbValuesAvailable
              },
              on: {
                change: function($event) {
                  var $$a = _vm.rgbValuesAvailable,
                    $$el = $event.target,
                  ...
                  if (Array.isArray($$a)) {
                    var $$v = null,
                      $$i = _vm._i($$a, $$v)
                    if ($$el.checked) {
                      $$i < 0 && (_vm.rgbValuesAvailable = $$a.concat([$$v]))
                    } else {
                      $$i > -1 &&
                        (_vm.rgbValuesAvailable = $$a
                          .slice(0, $$i)
                          .concat($$a.slice($$i + 1)))
                    }
                  } else {
                    _vm.rgbValuesAvailable = $$c
                  }
                }
              }
            }),
            _vm._v(" "),
            _c("label", [_vm._v(_vm._s(_vm.i18n("ADD_RGB_VALUES")))])
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm.rgbValuesAvailable && _vm.visible
        ? _c("verte", {
            staticClass: "level51-verte level51-verte-horizontal",
            attrs: {
              picker: "square",
              model: _vm.payload.mode,
              "show-history": false,
              draggable: false,
              "enable-alpha": false,
              "rgb-sliders": true,
            ...
            model: {
              value: _vm.inRgbMode ? _vm.rgb : _vm.simpleValue,
              callback: function($$v) {
                _vm.inRgbMode ? _vm.rgb : (_vm.simpleValue = $$v)
              },
              expression: "inRgbMode ? rgb : simpleValue"
            }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.inRgbMode
        ? [
            _c("input", {
              attrs: {
                type: "hidden",
                name: _vm.payload.name + "[R]",
                min: "0",
                max: "255"
              },
              domProps: { value: _vm.colorObject.r }
            }),
            _vm._v(" "),
            _c("input", {
              attrs: {
                type: "hidden",
                name: _vm.payload.name + "[G]",
                min: "0",
                max: "255"
              },
              domProps: { value: _vm.colorObject.g }
            }),
            _vm._v(" "),
            _c("input", {
              attrs: {
                type: "hidden",
                name: _vm.payload.name + "[B]",
                min: "0",
                max: "255"
              },
              domProps: { value: _vm.colorObject.b }
            })
          ]
        : _vm._e(),
      _vm._v(" "),
      _vm.inHexMode
        ? [
            _c("input", {
              ...
              domProps: {
                value: _vm.rgbValuesAvailable ? _vm.simpleValue : null
              }
            })
          ]
        : _vm._e()
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi @babel/polyfill/noConflict src/colorPickerField.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill/noConflict */"./node_modules/@babel/polyfill/noConflict.js");
module.exports = __webpack_require__(/*! src/colorPickerField.js */"./client/src/js/colorPickerField.js");
